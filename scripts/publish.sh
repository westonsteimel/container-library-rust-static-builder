...
docker_base_repo="docker.io/${DOCKER_USERNAME}/rust-static-builder"
ghcr_base_repo="ghcr.io/${GITHUB_OWNER}/rust-static-builder"
quay_base_repo="quay.io/${QUAY_USERNAME}/rust-static-builder"
